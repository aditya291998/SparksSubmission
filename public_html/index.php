            ...
            <div class="banner-image">
                <div class="inner-banner-image">
                    <div class="banner_content">
                        <h1>The Sparks Foundation</h1><br>
                        <p>Click on below link to transfer credits</p><br>
                        <a href="transfer.php" class="button  btn-danger btn-lg active">Transfer Credit</a>
                    </div>
                </div>
        </div>
        </div>
